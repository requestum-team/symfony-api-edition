...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'email', 'password', 'plainPassword', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'enabled', 'confirmationToken', 'createdAt', 'updatedAt'];
        }
